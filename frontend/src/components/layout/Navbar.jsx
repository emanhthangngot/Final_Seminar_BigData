...
import { Activity, Database, Menu, Search, Wifi } from 'lucide-react'

const TITLE_MAP = {
  '/dashboard': 'Vector Database RAG Benchmark',
  '/benchmark-workflow': 'Benchmark Workflow',
  '/databases/qdrant': 'Qdrant Demo',
  '/databases/weaviate': 'Weaviate Demo',
  '/databases/milvus': 'Milvus Demo',
    ...
    <header className="relative z-20 flex min-h-[84px] flex-shrink-0 items-center gap-3 px-4 pt-4 md:px-6 lg:px-8">
      ...
      <div className="glass-panel flex min-w-0 flex-1 items-center justify-between gap-3 rounded-3xl px-4 py-3">
        <div className="min-w-0">
          <p className="font-mono text-[10px] uppercase tracking-[0.28em] text-cyan/70">Benchmark dashboard</p>
        ...
        <div className="hidden min-w-[280px] max-w-md flex-1 items-center gap-2 rounded-2xl border border-white/10 bg-white/[0.055] px-3 py-2 xl:flex">
          ...
          <span className="text-sm text-slate-500">Setup, retrieval logic, recall, latency, and trade-off</span>
        ...
        <div className="flex items-center gap-2">
          <div className="hidden items-center gap-2 rounded-2xl border border-emerald/15 bg-emerald/5 px-3 py-2 md:flex">
            ...
            <span className="font-mono text-[11px] text-emerald">local API</span>
          </div>
